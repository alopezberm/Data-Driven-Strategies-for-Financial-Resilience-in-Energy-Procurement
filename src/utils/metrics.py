...
def _validate_metric_inputs(
    ...
    """Validate and align metric inputs."""
...
if __name__ == "__main__":
    ...
    print("MAPE:", compute_mape(y_true, y_pred))
    print("Pinball:", compute_pinball(y_true, y_pred, quantile=0.9))
    print("Summary:", summarize_regression_metrics(y_true, y_pred, quantile=0.9))